...
export default class NatureFactory extends IEntityFactory {
    create(type, x, y, options = {}) {
        ...
        // 🔍 [Data Connection] 설정 파일에서 자원 속성 미리 가져오기
        ...
        if (type.includes('tree')) {
            ...
            builder.addComponent('Resource', new ResourceNode(type, 10, config.type || 'resource'));
        }
    ...
    _setupPlant(builder, type, quality, config) {
