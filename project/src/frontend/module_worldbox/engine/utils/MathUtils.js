export default class MathUtils {
    constructor() {
        ...
        this.permutation = new Uint8Array([151, 160, 137, 91, 90, 15,
    ...
    // 거리 기반 밀어내기 (Push / Separation) 벡터 계산
    static resolveCollisionPush(pos1, pos2, minDistance) {
        ...
        if (distSq < minDistance * minDistance && distSq > 0) {
            ...
            const nx = dx / dist;
            const ny = dy / dist;
            return { pushX: nx * overlap * 0.5, pushY: ny * overlap * 0.5 };
        }
